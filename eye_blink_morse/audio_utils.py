...
class AudioManager:
    ...
    def __init__(self):
        ...
        # NO TTS ENGINE INITIALIZATION HERE! pyttsx3.speak handles it.
        # self._init_tts() # <--- REMOVED
    ...
    def _tts_thread_worker(self):
        ...
        while not self.tts_stop_event.is_set():
            try:
                ...
                # --- MODIFIED SECTION ---
                # Use pyttsx3.speak(text) instead of engine.say() and engine.runAndWait()
                # Note: pyttsx3.speak() is blocking and ignores the engine properties (rate, volume) set previously.
                pyttsx3.speak(text)
    ...
    def _play_morse_blocking(self, morse_string: str):
        ...
        """
        # ... (Rest of the _play_morse_blocking implementation remains the same)
        if not morse_string:
            return
